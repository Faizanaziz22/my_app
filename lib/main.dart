    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.light(
          primary: Colors.lightGreen, // Set primary color to yellow
...
class _MaximumBidState extends State<MaximumBid> {
  int _currentBid = 60; // Initial bid value

  void _increaseBid() {
    setState(() {
      _currentBid += 40; // Increase bid by $50
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: Colors.blueGrey[700], // Dark background color
        child: Center(
          child: Column(
